...
class AgenciesController extends Controller {
    ...
    public function index() {
        ...
        //$records = Agency:::paginate(5);
        //$propertyNames = Agency:::first()["fillable"]; // without field "id"
        ...
        return view('agencies.index', compact('records', 'propertyNames', 'extPropertyValues', 'collection'));
    }
    ...
    public function show($slug) {
        //$record = Agency::with('agency', RELATED_TABLES)->find($slug);
        $record = Agency::findOrFail($slug);
        $extValues = $record["attributes"];
        ...
        return view('agencies.view', compact('record', 'extPropertyValues', 'type'));
    }
...
//                        ->add_column('action', '<a href="{{{ URL::to(\'agencies/\' . $id) }}}" class="btn btn-success btn-sm " '
