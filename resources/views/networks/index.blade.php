...
@section('title') Networks :: @parent @stop
...
<div class="page-header">
    <span style="vertical-align:top;font-size:1.6em;padding-right:3em;">Networks</span>
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ URL::to('networks/' . $item  ) }}" class="btn btn-success btn-sm "
