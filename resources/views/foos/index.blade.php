...
@section('title') Foos :: @parent @stop
...
<div class="page-header">
    <span style="vertical-align:top;font-size:1.6em;padding-right:3em;">Foos</span>
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ URL::to('foos/' . $item  ) }}" class="btn btn-success btn-sm "
