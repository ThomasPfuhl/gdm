...
@section('title') Agencies :: @parent @stop
...
<div class="page-header">
    <span style="vertical-align:top;font-size:1.6em;padding-right:3em;">Agencies</span>
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ URL::to('agencies/' . $item  ) }}" class="btn btn-success btn-sm "
