    ...
    <div class="container-fluid">
        ...
        <div class="tab-content ">
          <div id="keycloak" class="tab-pane active" >
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <h3>{!! trans('site/user.login') !!} with your Museum credentials</h3>
                <div class="well">
                    Please sign in with the Museum's  <a href="keycloak/authorize"><b>Central Authentication Service</b></a>.
                </div>

                <div class="embed-responsive">
                    <iframe class="embed-responsive-item" src="{{ env('GDM_PROTOCOL') }}://{{ env('GDM_URL') }}/keycloak/authorize" ></iframe>
                </div>
          ...
          <div id="local" class="tab-pane" >
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <h3>{!! trans('site/user.login_to_account') !!}</h3>
                <div class="well">
                    Please ask
...
<!--
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-6 col-md-offset-4">
                    <button type="submit" class="btn btn-primary" id="login" name="login" style="margin-right: 15px;">
                        Login
                    </button>
