    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="{{ (Request::is('dummies') ? 'active' : '') }}"><a href="{{ URL::to('dummies') }}">Dummies</a></li><li class="{{ (Request::is('Dummies') ? 'active' : '') }}"><a href="{{ URL::to('Dummies') }}">$cnames</a></li><li class="{{ (Request::is('Dummies') ? 'active' : '') }}"><a href="{{ URL::to('Dummies') }}">" . $cnames . "</a></li></ul>
