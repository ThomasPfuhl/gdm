        ...
        <div class="row">
            ...
            <div class="col-md-5" >
                <div style="float:right;color:black;font-size:1.1em;font-weight:bolder;">
                    <span style="color:#a2c026">g</span>eneric<br/>
                    <span style="color:#a2c026">d</span>ata<br/>
                    <span style="color:#a2c026">m</span>odule
                </div>
                <div style="float:right;margin-right:2em;margin-top:5px;display:inline-block;text-align:right;color:black;font-size:0.8em;">
                    ...
                    <br/>
                    author: <a href="mailto:thomas.pfuhl@mfn.berlin">thomas.pfuhl@mfn.berlin</a>
                    <br/>
                    source code:
